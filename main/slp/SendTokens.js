...
export async function sendToken (fromWalletName, toAddress, amount) {
    // Open the wallet generated with create-wallet.
    let walletInfo
    try {
        walletInfo = require(`../wallets/${fromWalletName}-wallet.json`)
    } catch (err) {
        console.log(
    ...
    try {
        ...
        // different address.
        if (toAddress === '') toAddress = walletInfo.slpAddress
